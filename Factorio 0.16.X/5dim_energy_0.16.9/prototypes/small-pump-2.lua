...
--Entity
  {
    ...
    animations =
    {
      north =
      {
        filename = "__5dim_energy__/graphics/icon/icon_5d_small-pump-up_2.png",
        width = 46,
        height = 56,
        frame_count = 8,
      ...
      east =
      {
        filename = "__5dim_energy__/graphics/icon/icon_5d_small-pump-right_2.png",
        width = 51,
        height = 56,
        frame_count = 8,
      ...
      south =
      {
        filename = "__5dim_energy__/graphics/icon/icon_5d_small-pump-down_2.png",
        width = 61,
        height = 58,
        frame_count = 8,
      ...
      west =
      {
        filename = "__5dim_energy__/graphics/icon/icon_5d_small-pump-left_2.png",
        width = 56,
        height = 44,
        frame_count = 8,
        shift = {0.3125, 0.0625},
