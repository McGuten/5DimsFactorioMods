...
table.insert(
    data.raw.technology["physical-projectile-damage-1"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-big", modifier = 0.1}
)
table.insert(
    data.raw.technology["physical-projectile-damage-1"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-exp", modifier = 0.1}
)
...
table.insert(
    ...
    {type = "turret-attack", turret_id = "5d-gun-turret-small", modifier = 0.2}
)
table.insert(
    data.raw.technology["physical-projectile-damage-3"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-big", modifier = 0.2}
)
table.insert(
    data.raw.technology["physical-projectile-damage-3"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-exp", modifier = 0.2}
)
...
table.insert(
    ...
    {type = "turret-attack", turret_id = "5d-gun-turret-small", modifier = 0.4}
)
table.insert(
    data.raw.technology["physical-projectile-damage-6"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-big", modifier = 0.4}
)
table.insert(
    data.raw.technology["physical-projectile-damage-6"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-exp", modifier = 0.4}
)

table.insert(
    data.raw.technology["physical-projectile-damage-7"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-small", modifier = 0.7}
)
table.insert(
    data.raw.technology["physical-projectile-damage-7"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-big", modifier = 0.7}
)
table.insert(
    data.raw.technology["physical-projectile-damage-7"].effects,
    {type = "turret-attack", turret_id = "5d-gun-turret-exp", modifier = 0.7}
)

table.insert(
    data.raw.technology["refined-flammables-1"].effects,
    {type = "turret-attack", turret_id = "5d-flamethrower-turret-2", modifier = 0.2}
)
table.insert(
...
table.insert(
    ...
    {type = "turret-attack", turret_id = "5d-flamethrower-turret-2", modifier = 0.3}
)
table.insert(
...
table.insert(
    ...
    {type = "turret-attack", turret_id = "5d-flamethrower-turret-2", modifier = 0.4}
)
table.insert(
