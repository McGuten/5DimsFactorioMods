data:extend(
    {
        -- Item
        {
            type = "item",
            name = "5d-concrete-b2",
            icon = "__5dim_decoration__/graphics/icon/concreteB2.png",
        ...
        {
            {
                ...
                minable = {hardness = 0.2, mining_time = 0.5, result = "5d-concrete-b2"},
                ...
                variants = {
                    main = {
                        {
                            picture = "__5dim_decoration__/graphics/icon/concrete1B2.png",
                            count = 16,
                            size = 1
                        },
                        {
                            picture = "__5dim_decoration__/graphics/icon/concrete2B2.png",
                            count = 4,
                            size = 2,
                            probability = 0.39
                        },
                        {
                            picture = "__5dim_decoration__/graphics/icon/concrete4B2.png",
                            count = 4,
                            size = 4,
                            probability = 1
                        }
