...
-- Basic changes
    ...
    {type = "double-setting", name = "5d-mining-speed", setting_type = "startup", default_value = 0.01, minimum_value = 0.001, maximum_value = 1000, localised_name = "Mining speed (Default 0.01)"},
