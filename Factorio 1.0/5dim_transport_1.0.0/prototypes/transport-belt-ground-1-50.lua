data:extend(
  {
    ...
    {
      type = "item",
      name = "5d-mk1-transport-belt-to-ground-50",
      icon = "__5dim_transport__/graphics/icon/icon_5d_ground-structure_1_50_.png",
      icon_size = 32,
      subgroup = "transport-ground-50",
      order = "a",
      place_result = "5d-mk1-transport-belt-to-ground-50",
      stack_size = 50
    },
    --Recipe
    {
      ...
      result_count = 2,
      result = "5d-mk1-transport-belt-to-ground-50"
    },
    --Entity
    {
      ...
      minable = {hardness = 0.2, mining_time = 0.5, result = "5d-mk1-transport-belt-to-ground-50"},
      icon_size = 32,
      max_health = 70,
