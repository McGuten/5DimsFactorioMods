    ...
    {
        {
            ...
            animations = {
                spawner_idle_animation(0, physicalBiterTint),
                spawner_idle_animation(1, physicalBiterTint),
                spawner_idle_animation(2, physicalBiterTint),
                spawner_idle_animation(3, physicalBiterTint)
            },
        ...
        --Small
        {
            ...
            attack_parameters = {
                ...
                animation = biterattackanimation(smallbitterscale, physicalBiterTint, secondColor)
            },
            vision_distance = 30,
            movement_speed = 0.2,
            ...
            run_animation = biterrunanimation(smallbitterscale, physicalBiterTint, secondColor)
        },
        {
            type = "corpse",
            ...
            animation = biterdieanimation(smallbitterscale, physicalBiterTint, secondColor)
        },
        --Medium
        {
            type = "unit",
            ...
            run_animation = biterrunanimation(mediumbitterscale, physicalBiterTint, secondColor)
        },
        {
            type = "corpse",
            ...
            time_before_removed = 15 * 60 * 60,
            final_render_layer = "corpse",
            animation = biterdieanimation(mediumbitterscale, physicalBiterTint, secondColor)
        },
        --Big
        {
            type = "unit",
            ...
            attack_parameters = {
                ...
                animation = biterattackanimation(bigbitterscale, physicalBiterTint, secondColor)
            },
            vision_distance = 30,
            movement_speed = 0.17,
            ...
            run_animation = biterrunanimation(bigbitterscale, physicalBiterTint, secondColor)
        },
        {
            type = "corpse",
            ...
            time_before_removed = 15 * 60 * 60,
            final_render_layer = "corpse",
            animation = biterdieanimation(bigbitterscale, physicalBiterTint, secondColor)
        },
        --Behemoth
        {
            type = "unit",
            ...
            attack_parameters = {
                ...
                animation = biterattackanimation(behemothbitterscale, physicalBiterTint, secondColor)
            },
            vision_distance = 30,
            movement_speed = 0.17,
            distance_per_frame = 0.2,
            ...
            run_animation = biterrunanimation(behemothbitterscale, physicalBiterTint, secondColor)
        },
        {
            type = "corpse",
            ...
            time_before_removed = 15 * 60 * 60,
            final_render_layer = "corpse",
            animation = biterdieanimation(behemothbitterscale, physicalBiterTint, secondColor)
        }
    }
)
