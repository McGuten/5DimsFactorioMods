data:extend(
    {
        -- Item
        {
            type = "item",
            name = "5d-concrete-a",
            icon = "__5dim_decoration__/graphics/icon/concreteA.png",
        ...
        {
            {
                ...
                minable = {hardness = 0.2, mining_time = 0.5, result = "5d-concrete-a"},
                ...
                variants = {
                    main = {
                        {
                            picture = "__5dim_decoration__/graphics/icon/concrete1A.png",
                            count = 16,
                            size = 1
                        },
                        {
                            picture = "__5dim_decoration__/graphics/icon/concrete2A.png",
                            count = 4,
                            size = 2,
                            probability = 0.39
                        },
                        {
                            picture = "__5dim_decoration__/graphics/icon/concrete4A.png",
                            count = 4,
                            size = 4,
                            probability = 1
                        }
