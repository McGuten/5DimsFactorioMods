...
--Copies
item = table.deepcopy(data.raw["item"]["storage-tank"])
recipe = table.deepcopy(data.raw["recipe"]["storage-tank"])
entity = table.deepcopy(data.raw["storage-tank"]["storage-tank"])
...
entity.fluid_box.base_area = 1000
