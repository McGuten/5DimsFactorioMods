...
-- Item
  {
    type = "item",
    name = "5d-pipe-to-ground-mk3-50",
    icon = "__5dim_transport__/graphics/icon/pipe/icon_5d_pipe-to-underground_3_50_.png",
    flags = {"goes-to-quickbar"},
    icon_size = 32,
    subgroup = "transport-pipe-ground-50",
    order = "c[basic-pipe-ground]",
    place_result = "5d-pipe-to-ground-mk3-50",
    stack_size = 50
  },
...
--Recipe
  {
    ...
    result_count = 2,
    result = "5d-pipe-to-ground-mk3-50"
  },
...
--Entity
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "5d-pipe-to-ground-mk3-50"},
    icon_size = 32,
    max_health = 50,
