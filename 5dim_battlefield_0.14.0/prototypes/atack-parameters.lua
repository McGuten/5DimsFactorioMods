...
function rocketlaunchersmall(data)
  return
  {
    ...
    sound = make_spitter_roars(data.roarvolume),
    animation = biterattackanimation(smallbitterscale, rocketspittertint),
  }
end
...
function rocketlaunchermedium(data)
  return
  {
    ...
    sound = make_spitter_roars(data.roarvolume),
    animation = biterattackanimation(mediumbitterscale, rocketspittertint),
  }
end
...
function rocketlauncherbig(data)
  return
  {
    ...
    sound = make_spitter_roars(data.roarvolume),
    animation = biterattackanimation(bigbitterscale, rocketspittertint),
  }
end
...
function rocketlauncherbehemoth(data)
  return
  {
    ...
    sound = make_spitter_roars(data.roarvolume),
    animation = biterattackanimation(behemothbitterscale, rocketspittertint),
  }
end
...
function rocketlauncherexp(data)
  return
  {
    ...
    sound = make_spitter_roars(data.roarvolume),
    animation = biterattackanimation(expbitterscale, rocketspittertint),
  }
end
