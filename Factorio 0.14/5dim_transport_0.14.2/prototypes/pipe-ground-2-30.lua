...
-- Item
  {
    type = "item",
    name = "5d-pipe-to-ground-mk2-30",
    icon = "__5dim_transport__/graphics/icon/pipe/icon_5d_pipe-to-underground_2_30_.png",
    flags = {"goes-to-quickbar"},
    subgroup = "transport-pipe-ground-30",
    order = "b[basic-pipe-ground]",
    place_result = "5d-pipe-to-ground-mk2-30",
    stack_size = 50
  },
...
--Recipe
  {
    ...
    result_count = 2,
    result = "5d-pipe-to-ground-mk2-30"
  },
...
--Entity
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "5d-pipe-to-ground-mk2-30"},
    max_health = 50,
