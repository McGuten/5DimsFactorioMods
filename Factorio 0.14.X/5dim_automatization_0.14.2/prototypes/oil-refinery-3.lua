...
-- Item
  {
    ...
    icon = "__5dim_automatization__/graphics/icon/oil-refinery_3_.png",
    flags = {"goes-to-quickbar"},
    subgroup = "liquid-refinery",
    order = "c",
    place_result = "5d-oil-refinery-3",
    stack_size = 10
  },
...
--Entity
  {
    ...
    minable = {mining_time = 1, result = "5d-oil-refinery-3"},
    max_health = 300,
    corpse = "big-remnants",
    ...
    animation =
    {
      north =
      {
        filename = "__5dim_automatization__/graphics/icon/oil-refinery_3.png",
        width = 337,
        height = 255,
        frame_count = 1,
