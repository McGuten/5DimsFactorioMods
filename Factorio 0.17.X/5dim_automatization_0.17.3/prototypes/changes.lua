...
data.raw["loader"]["loader"].structure =
{
	direction_in =
	{
		sheet =
		{
			filename = "__5dim_automatization__/graphics/icon/loader.png",
			priority = "extra-high",
			width = 128,
			height = 128
		}
...
data.raw["loader"]["fast-loader"].structure =
{
	direction_in =
	{
		sheet =
		{
			filename = "__5dim_automatization__/graphics/icon/fast-loader.png",
			priority = "extra-high",
			width = 128,
			height = 128
		}
...
data.raw["loader"]["express-loader"].structure =
{
	direction_in =
	{
		sheet =
		{
			filename = "__5dim_automatization__/graphics/icon/express-loader.png",
			priority = "extra-high",
			width = 128,
			height = 128
		}
