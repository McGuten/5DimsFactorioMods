...
--Item
  {
    ...
    icon = "__5dim_mining__/graphics/icon/icon_5d_mining_drill_range1_.png",
    flags = {"goes-to-quickbar"},
    icon_size = 32,
    subgroup = "mining-range",
    order = "b",
    place_result = "5d-mining-drill-range-1",
    stack_size = 50
  },
...
--Entity
  {
    ...
    minable = {mining_time = 1, result = "5d-mining-drill-range-1"},
    icon_size = 32,
    max_health = 300,
    ...
    animations =
    {
      north =
      {
        ...
        line_length = 8,
        shift = {0.2, -0.2},
        filename = "__5dim_mining__/graphics/icon/icon_5d_mining_drill_range1_north.png",
        frame_count = 64,
        animation_speed = 0.5,
      ...
      east =
      {
        ...
        line_length = 8,
        shift = {0.45, 0},
        filename = "__5dim_mining__/graphics/icon/icon_5d_mining_drill_range1_east.png",
        frame_count = 64,
        animation_speed = 0.5,
        run_mode = "forward-then-backward",
      },
      south =
      {
        ...
        line_length = 8,
        shift = {0.15, 0},
        filename = "__5dim_mining__/graphics/icon/icon_5d_mining_drill_range1_south.png",
        frame_count = 64,
        animation_speed = 0.5,
        run_mode = "forward-then-backward",
      },
      west =
      {
        ...
        line_length = 8,
        shift = {0.25, 0},
        filename = "__5dim_mining__/graphics/icon/icon_5d_mining_drill_range1_west.png",
        frame_count = 64,
        animation_speed = 0.5,
        run_mode = "forward-then-backward",
      }
