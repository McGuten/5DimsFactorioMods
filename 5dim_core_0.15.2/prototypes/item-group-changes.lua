...
data.raw.item["personal-laser-defense-equipment"].subgroup = "armor-defense";
data.raw.item["personal-laser-defense-equipment"].order = "aa";
data.raw.item["discharge-defense-equipment"].subgroup = "armor-defense";
data.raw.item["discharge-defense-equipment"].order = "ba";
data.raw.capsule["discharge-defense-remote"].subgroup = "armor-defense";
...
data.raw.item["filter-inserter"].subgroup = "inserters-smart";
...
data.raw.item["stack-inserter"].subgroup = "inserters-burner";
data.raw.item["stack-inserter"].order = "b";
data.raw.item["stack-filter-inserter"].subgroup = "inserters-burner";
data.raw.item["stack-filter-inserter"].order = "c";
...
data.raw.tool["high-tech-science-pack"].subgroup = "intermediate-lab"
...
data.raw.item["beacon"].subgroup = "logistic-beacon"
...
data.raw.item["uranium-235"].order = "ac"
data.raw.item["uranium-238"].subgroup = "plates-plates"
data.raw.item["uranium-238"].order = "ad"
...
data.raw.item["raw-wood"].subgroup = "plates-fuel"
data.raw.item["raw-wood"].order = "a"
...
data.raw["item-with-entity-data"]["cargo-wagon"].subgroup = "trains-rails"
data.raw["item-with-entity-data"]["cargo-wagon"].order = "a"
data.raw["item-with-entity-data"]["fluid-wagon"].subgroup = "trains-rails"
data.raw["item-with-entity-data"]["fluid-wagon"].order = "b"
